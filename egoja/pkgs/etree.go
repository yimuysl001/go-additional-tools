...
func Etree() {
	RegisterImport("etree", map[string]any{
		"ErrXML":        etree.ErrXML,
		...
		"TraverseXmlRoot": TraverseXmlRoot,
		"SetElementValue": SetElementValue,
		"DelAttr":         DelAttr,
		"GetElement":      GetElement,
		"GetElements":     GetElements,
		"GetROOT":         GetROOT,
		"GetElementRoot":  GetElementRoot,
		"ResultToXml":     ResultToXml,
		"RecordToXml":     RecordToXml,
		"GetMustDoc":      GetMustDoc,
		"GetDoc":          GetDoc,
	})
}
...
func RecordToXml(vs gdb.Record, rootTag ...string) string {
	...
	xmlString := gjson.New(vs).MustToXmlIndentString(rootTag...)
