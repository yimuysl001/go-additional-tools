...
func GoEnv() {
	RegisterImport("time", map[string]any{
		"ANSIC":                  time.ANSIC,
		"After":                  time.After,
	...
	RegisterImport("fmt", map[string]any{
		"Errorf":   fmt.Errorf,
		"Fprint":   fmt.Fprint,
		"Fprintf":  fmt.Fprintf,
	...
	RegisterImport("bytes", map[string]any{
	...
	RegisterImport("encoding/json", map[string]any{
		"Marshal":   json.Marshal,
		"Unmarshal": json.Unmarshal,
	})
	RegisterImport("errors", map[string]any{
		"New": errors.New,
		"Is":  errors.Is,
		"As":  errors.As,
	})
	RegisterImport("io", map[string]any{
		"Copy":             io.Copy,
		"CopyN":            io.CopyN,
		"EOF":              io.EOF,
	...
	RegisterImport("os", map[string]any{
		"Args":              os.Args,
		"Chdir":             os.Chdir,
		"Chmod":             os.Chmod,
		"Chown":             os.Chown,
	...
	RegisterImport("strings", map[string]any{
	...
	RegisterImport("sync", map[string]any{
	...
	RegisterImport("sort", map[string]any{
	...
	RegisterImport("path", map[string]any{
		"Base":          path.Base,
		"Clean":         path.Clean,
		"Dir":           path.Dir,
	...
	RegisterImport("path/filepath", map[string]any{
		"Abs":          filepath.Abs,
		"Base":         filepath.Base,
	...
	RegisterImport("runtime", map[string]any{
		"GC":         runtime.GC,
	...
	RegisterImport("regexp", map[string]any{
		"Match":            regexp.Match,
	...
	RegisterImport("math", map[string]any{
		"Abs":             math.Abs,
		"Acos":            math.Acos,
		"Acosh":           math.Acosh,
		"Asin":            math.Asin,
	...
	RegisterImport("math/big", map[string]any{
		"Above":         big.Above,
	...
	RegisterImport("math/rand", map[string]any{
	...
	RegisterImport("net", map[string]any{
	...
	RegisterImport("net/http/cookiejar", map[string]any{
		"New":     cookiejar.New,
		"Options": cookiejar.Options{},
	})
	RegisterImport("net/http", map[string]any{
	...
	RegisterImport("net/url", map[string]any{
